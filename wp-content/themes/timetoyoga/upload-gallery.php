<?php
/* Template Name: Galleries upload */  
...
foreach (new DirectoryIterator($path) as $file) {
    ...
    if ($file->isDir()) {
        ...
        if($user!==false){                                        
              ...
              if(is_numeric($name[$length]) && $name[$length-3]=='x') {
                ...
                continue;                 
                  ...
                  if($count==0){
                    ...
                    $movefile = wp_upload_bits($file2->getFilename(), null, file_get_contents($path_file));   
                    if ( $movefile ) {
                      $attachment = array(
          ...
          $path2 = './wp-content/themes/timetoyoga/galleries/'.$file->getFilename().'/photos/featured';
