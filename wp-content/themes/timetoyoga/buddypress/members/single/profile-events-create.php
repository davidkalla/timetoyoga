...
<form id="profile-event-form" name="profile-event-form" method="post" action="" class="standard-form" enctype="multipart/form-data">
	...
	<p>
		<label for="event-description"><?php echo __( 'Description', 'bp-simple-events' ); ?>: *</label>
		 <?php wp_editor( $pp_ec->description, "event-description", $settings = array('media_buttons'=>false,'editor_height'=>400,'quicktags'=>false) ); ?>
		<?php /* ?><textarea id="event-description" name="event-description" ><?php echo $pp_ec->description; ?></textarea><?php */ ?>
	</p>
